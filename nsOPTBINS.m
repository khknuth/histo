...
% The nested sampling algorithm was modified from code Skilling and Sivia
% in reference #2 below, which was Copyrighted by Skilling and Sivia in
% 2006 under the GNU GPL.
%
...
%
% It is respectfully that requested reference #1 below are cited in 
% publications involving the use of this algorithm.  The other references,
% if applicable should also be considered for citation.
%
% References:
...
%
% 2. Sivia and Skilling, "Data Analysis: A Bayesian Tutorial", 2nd Ed., 
% Oxford Univ. Press, 2006, pp. 188-189.
%
% 3. Knuth K.H., Castle J.P., Wheeler K.R. 2006. Identifying excessively
...
for i = 1:n
    ...
    if ((i > 5) || strcmpi(mode,'MEAN'))  % if we are to report the mean

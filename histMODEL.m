...
%   MODEL = histMODEL(Y,M) bins the elements of the array Y into a set of 
%               containers in a multi-dimensional space, and returns the 
%               number of elements in each container.
%
%   Y is a D x N array, where Y(i,:) is the ith datum point.
%   M is a 1 x D array, where M(j) is number of bins in the jth dimension
%
...
%           model{3} = M is a 1 x D array of the number of bins along 
%                       each dimension d
%           model{4} = ps is a multidimensional array of mean bin 
%                       probabilities with dimensions dictated by M
%           model{5} = vs is a multidimensional array of bin probability 
%                       variances with dimensions dictated by M
